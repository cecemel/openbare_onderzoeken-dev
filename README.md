# openbare_onderzoeken-dev

## deployment of dev environment for the 'openbare_onderzoeken' app
...
git clone --recursive https://github.com/cecemel/openbare_onderzoeken-dev.git
cd openbare_onderzoeken-dev
