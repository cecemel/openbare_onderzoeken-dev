...
DATABASE_IMAGE = "openbare_onderzoeken-dev/postgres:latest"
DATABASE_CONTAINER_NAME = "openbare_onderzoeken-migration-db"
...
def start_db():
    ...
    time.sleep(10)
    _exec_command("docker run --link {}:postgres openbare_onderzoeken-dev/postgres-checker:latest".format(DATABASE_CONTAINER_NAME))
